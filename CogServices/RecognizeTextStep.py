...
input_path   = wasb_path + "raw_data/cog_services/celebs/celeb/"
output_path  = wasb_path + "raw_data/cog_services/celebs/text/"
...
recognizeText = RecognizeText()\
  ...
  .setUrl("https://"+region+".api.cognitive.microsoft.com/vision/v2.0/recognizeText")\
